...
using asp.net_proje_denemesi;
using asp.net_proje_denemesi.Repositories;
...
builder.Services.AddTransient<IKullaniciSiparisRepository, KullaniciSiparisRepository>();
