...
namespace WebApplicationProjeUI.Areas.Identity.Pages.Account.Manage
{
    public class DownloadPersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            personalData.Add($"Kimlik Doğrulayıcı Anahtarı", await _userManager.GetAuthenticatorKeyAsync(user));

            Response.Headers.Add("İçerik Düzenleme", "attachment; filename=PersonalData.json");
